...
adata_object <- adata$read_h5ad('C:/Users/hyjfo/Documents/WT_cellchat_test.h5ad')
...
pairLR.MHC
LR.show <- pairLR.MHC[1,] # choose MHC-II5_CCR3
LR.show
...
netAnalysis_signalingRole_network(object =cellchat, signaling = c("MHC-II"), slot.name = "netP", measure = c("outdeg", "indeg", "fWTbet", "info"), measure.name = c("Sender", "Receiver", "Mediator", "Influencer"), color.use =simple_colors, color.heatmap = "BuGn", width = 8, height = 2.5, font.size = 8)
...
saveRDS(cellchat, file = "C:/Users/hyjfo/Documents/WT_cellchat_1000_test.rds")
cellchat <- readRDS(file = "C:/Users/hyjfo/Documents/WT_cellchat_1000_test.rds")
